...
for i in 1 2 3 4 5
do
srun --threads-per-core=1 ${executable} --n 62681 --nev 100 --nex 100 --path_in=${DATA_PATH}/HfO2-62k/mat_d_00_01.bin --complex 1 --opt S --mode R  --deg 20 --lanczosIter 40 --numLanczos 10 --tol 1e-10
done
