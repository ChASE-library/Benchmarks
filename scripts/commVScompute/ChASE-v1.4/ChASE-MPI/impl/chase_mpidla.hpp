...
public:
   ...
   */
                        ...
                        bool isCcopied = false) override
    {
        ...
        if (isSameDist_ && cuda_aware_)
        {
            ...
            elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
            std::cout << "+ asynCxHGatherC/Bcast," << elapsed.count() << std::endl;
            ...
            elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
            std::cout << "+ asynCxHGatherC/AllReduce," << elapsed.count() << std::endl;
        }
        else
        {
            for (auto i = 0; i < c_lens.size(); i++)
   ...
   */
    void RR(std::size_t block, std::size_t locked, Base<T>* ritzv) override
    {
        ...
        elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
        std::cout << "+ RR/AllReduce," << elapsed.count() << std::endl;
              ...
              std::size_t unconverged) override
    {
        ...
        elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
        std::cout << "+ Resd/AllReduce," << elapsed.count() << std::endl; 
        ...
        if (rsd != matrices_->Resid().ptr())
        {
            ...
            elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
            std::cout << "+ Resd/D2H," << elapsed.count() << std::endl; 
        }
#ifdef USE_NSIGHT
        nvtxRangePop();
#endif
        ...
        elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
        std::cout << "+ Resd/Sqrt," << elapsed.count() << std::endl;	
    }
   ...
   */
    ...
    void cholQR(std::size_t locked, Base<T> cond) override
    {
        ...
        elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
        std::cout << "+ QR/AllReduce," << elapsed.count() << std::endl;
        ...
        if (cond > cond_threshold_1)
        {
            ...
            elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
            std::cout << "+ QR/NRM2," << elapsed.count() << std::endl;
            ...
            if (shift < 10)
            {
                ...
                elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
                std::cout << "+ QR/Shift," << elapsed.count() << std::endl;
#ifdef USE_NSIGHT
                nvtxRangePop();
#endif
            }
