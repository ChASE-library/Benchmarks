...
for i in 1 2 3 4 5
do
CHASE_DISABLE_CHOLQR=1 srun --threads-per-core=1 ${executable} --n 29528 --nev 2560 --nex 400 --path_in=${DATA_PATH}/TiO2-29k/gmat\ \ 1\ \ 1.bin --complex 1 --opt S --mode R  --deg 20 --lanczosIter 40 --numLanczos 10 --tol 1e-10
done
