...
srun --threads-per-core=1 ${executable} --n 12455 --nev 1076 --nex 100 --path_in=${DATA_PATH}/TiO2-12k/gmat\ \ 1\ \ 1.bin --complex 1 --opt ${OPT} --mode R  --deg 20 --lanczosIter 40 --numLanczos 10 --tol 1e-10
