...
srun --threads-per-core=1 ${executable} --n 115459 --nev 100 --nex 40 --path_in=${DATA_PATH}/In2O3-115k/mat.bin --complex 1 --opt ${OPT} --mode R  --deg 20 --lanczosIter 40 --numLanczos 10 --tol 1e-10
