...
srun --threads-per-core=1 ${executable} --n 9273 --nev 256 --nex 60 --path_in=${DATA_PATH}/NaCl-9k/gmat\ \ 1\ \ 1.bin --complex 1 --opt ${OPT} --mode R  --deg 20 --lanczosIter 40 --numLanczos 10 --tol 1e-10
