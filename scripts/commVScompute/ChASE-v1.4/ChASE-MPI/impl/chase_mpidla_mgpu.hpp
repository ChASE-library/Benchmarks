...
public:
                        ...
                        bool isCcopied) override
    {
        ...
        if (!isCcopied)
        {
            ...
            elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
            std::cout << "+ asynCxHGatherC/H2D," << elapsed.count() << std::endl;            
        }
#endif
        start = std::chrono::high_resolution_clock::now();
        ...
        elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
        std::cout << "+ asynCxHGatherC/GEMM," << elapsed.count() << std::endl; 
        ...
        elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
        std::cout << "+ asynCxHGatherC/D2H," << elapsed.count() << std::endl;         
#endif
    }
                ...
                bool first) override
    {
        ...
        elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
        std::cout << "+ QR/syherk," << elapsed.count() << std::endl;  
    ...
    int potrf(char uplo, std::size_t n, T* a, std::size_t lda, bool isinfo = true) override
    {
        ...
        elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
        std::cout << "+ QR/Potrf," << elapsed.count() << std::endl;        
#ifdef USE_NSIGHT
        nvtxRangePop();
#endif
              ...
              std::size_t ldb, bool first) override
    {
        ...
        elapsed = std::chrono::duration_cast<std::chrono::duration<double>>(end - start);
        std::cout << "+ QR/Trsm," << elapsed.count() << std::endl;         
#if !defined(CUDA_AWARE)
        if (!first)
        {
            start = std::chrono::high_resolution_clock::now();                            
